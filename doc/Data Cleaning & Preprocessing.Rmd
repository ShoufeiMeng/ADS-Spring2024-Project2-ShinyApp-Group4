...
```{r}
write.csv(data_merged, "~/ADS-Spring2024-Project2-ShinyApp-Group4/data/Disaster_Map.csv")
write.csv(monthly_disasters, "~/ADS-Spring2024-Project2-ShinyApp-Group4/data/Disaster_Monthly.csv")
write.csv(combined, "~/ADS-Spring2024-Project2-ShinyApp-Group4/data/Disaster_Hist.csv")
```